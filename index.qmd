...
format:
  html: 
    grid:
      ...
      margin-width: 400px
    other-links: 
      - text: "DAIOE Data Download (2010 to latest year)"
        icon: database-fill-down
        href: https://github.com/joseph-data/daioe_dataset
      - text: The original paper The DAIOE is developed, explained, validated, and applied in the most current version of the paper by Engberg et al. (2025)
        icon: book
        href: https://drive.google.com/file/d/1hHIGmXC8j0GDDkCJuZ76ub63Hq7CgRbS/view
...
::: {.callout-note icon="false" title="DAIOE at a glance"}
...
The original paper The DAIOE is developed, explained, validated, and applied in the most current version of the paper by [Engberg et al. (2025)](https://drive.google.com/file/d/1hHIGmXC8j0GDDkCJuZ76ub63Hq7CgRbS/view).

**Suggested citation**: @engberg2024

DAIOE data can be downloaded ➡️ [Github](https://github.com/joseph-data/daioe_dataset) (2010 to latest available year) and its full documentation specified.